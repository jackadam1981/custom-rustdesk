...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.jackadam.top:21116"];
pub const RS_PUB_KEY: &str = "dhaec8XvCtBVV3dHcTR3Fl7UzAwEFFvxGIWUBDJUyCI=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "https://rustdesk.jackadam.top:18443";
